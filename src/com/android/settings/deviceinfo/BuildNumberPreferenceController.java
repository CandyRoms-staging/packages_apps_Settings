...
public class BuildNumberPreferenceController extends BasePreferenceController implements
    ...
    public final static java.lang.String[] insults = {
            ...
            "Are you even trying?!",
            "its afterlife not stockRom",
            "This won't make you look cooler to your friends",
            "dont forget to rules number one",
            "You look like a person who plays PUBGay on his phone",
    };
    ...
    public CharSequence getSummary() {
        ...
        String candyVersion = VersionUtils.getcandyVersion();
        if (!candyVersion.equals("")){
            sb.append("\n");
            sb.append(candyVersion);
        }
        return sb.toString();
    }
